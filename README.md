...
# 🎮 WheelMates — Community Edition

**Team up, hit the road, deliver together.**
...
WheelMates is a casual multiplayer driving game where players team up as a crew of drivers to complete delivery runs, timed challenges, and chaotic street races across a colorful open city. This Community Edition is a standalone build that includes all released content and DLC packs in a self-contained package. It runs fully offline with no storefront required and no additional software needed.

Ideal for players who want a ready-to-run offline co-op driving game for casual sessions with friends on modest PCs.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3905450/3bde54de54f8a508d1eab1f7e9544b55b34c91dc/ss_3bde54de54f8a508d1eab1f7e9544b55b34c91dc.1920x1080.jpg?t=1788429316" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3905450/cd223ca755765f6d98aecdd41cfd70adff7ba4d9/ss_cd223ca755765f6d98aecdd41cfd70adff7ba4d9.1920x1080.jpg?t=1788429316" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3905450/98afee44aa5a155c3938da390c951a14f7989023/ss_98afee44aa5a155c3938da390c951a14f7989023.1920x1080.jpg?t=1788429316" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🚗 **Co-op Driving** — Team up with friends for shared delivery runs and crew-based challenges.
- 🏙️ **Open City Map** — Free-roam urban environment with shortcuts, ramps, and dynamic traffic.
- 🎮 **Split-Screen & LAN** — Local split-screen plus LAN or direct connection support for multiplayer.
- 🛞 **Vehicle Customization** — Tune engines, paint jobs, and wheels across a growing garage of vehicles.
- 🕹️ **Arcade Handling** — Accessible physics tuned for casual sessions and party play.
- 📦 **All Content Included** — Ships with every released DLC pack and seasonal event.
- 💾 **Offline Play** — Self-contained package runs completely offline after installation.
- ⚙️ **Low Hardware Demand** — Runs smoothly on modest PCs and scales well on older hardware.
...
- WheelMates: Night Shift Pack
- WheelMates: Beach Delivery Pack
- WheelMates: Retro Wheels Garage
...
| **Processor** | Intel Core i3-2100 or AMD FX-6300 | Intel Core i5-8400 or AMD Ryzen 5 2600 |
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti or AMD Radeon R7 260X | NVIDIA GeForce GTX 1060 6GB or AMD Radeon RX 580 |
| **Storage** | 6 GB available space | 6 GB available space on SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 11 compatible sound card; SSD recommended for faster load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\WheelMates\Saved`
